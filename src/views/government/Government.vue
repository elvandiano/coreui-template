                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12" align="right">
                                <b-button size="sm" variant="success" to="/pemerintah/tambah" class="mr-1"><i class="fa fa-plus"></i> Tambah Pemerintah</b-button>
                            </div>
                        </div>
                        <div class="row ml-0">
    ...
    export default {
        ...
        data() {
            return {
                ...
                // config table
                columns: ['numberStore', 'name', 'address1', 'address2','Email','Phone','actions',],
                tableData: [],
                optionsDataTable: {
                    headings: {
                        numberStore: 'No.',
        ...
        methods: {
            ...
            edit(id) {
                this.$router.replace('pemerintah/edit/'+id);
            }
            // cariPajak() {
            //     let dataSearch = {
