                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12" align="right">
                                <b-button size="sm" variant="success" to="/acara/tambah" class="mr-1"><i class="fa fa-plus"></i> Tambah Acara</b-button>
                            </div>
                        </div>
                        <div class="row ml-0">
    ...
    export default {
        ...
        data() {
            return {
                ...
                // config table
                columns: ['numberStore', 'name', 'Tanggal', 'Waktu', 'address1', 'address2','actions'],
                tableData: [],
                optionsDataTable: {
                    headings: {
                        numberStore: 'No.',
        ...
        methods: {
            ...
            edit(id) {
                this.$router.replace('acara/edit/'+id);
            }
            // cariPajak() {
            //     let dataSearch = {
